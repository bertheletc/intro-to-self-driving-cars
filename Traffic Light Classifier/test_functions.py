...
class Tests(unittest.TestCase):
    ...
    # Gathers any misclassified images that are red but mistakenly classified as green
    def gather_red_as_green(self, misclassified_images):
        
        # Create empty list to store these
        RED_AS_GREEN = []
